...
class NewMatrix
{
	...
	public function appendMatrix(m:NewMatrix)
	{
		return append(m.a, m.b, m.c, m.d, m.tx, m.ty);
	}
	
	public function prependMatrix(m:NewMatrix)
	{
	...
	public function appendTransform(x, y, scaleX, scaleY, rotation:Float, skewX:Float, skewY:Float, regX:Float, regY:Float)
	{
		var cos : Float;
		var sin : Float;
	...
	public function prependTransform(x, y, scaleX:Float, scaleY:Float, rotation:Float, skewX:Float, skewY:Float, regX, regY)
	{
		var cos : Float;
		var sin : Float;
