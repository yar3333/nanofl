...
**/
@:native('createjs.BitmapText') extern class BitmapText extends easeljs.display.DisplayObject {
	function new(?text:String, ?spriteSheet:easeljs.display.SpriteSheet):Void;
	/**
