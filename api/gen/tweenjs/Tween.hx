...
**/
@:native('createjs.Tween') extern class Tween extends tweenjs.AbstractTween {
	function new(target:Dynamic, ?props:tweenjs.Tween.TweenInitProps):Void;
	/**
	...
	**/
	function wait(duration:Float, ?passive:Bool):tweenjs.Tween;
	/**
	...
	**/
	function to(props:Dynamic, ?duration:Float, ?ease:Dynamic):tweenjs.Tween;
	/**
	...
	**/
	override function addLabel(label:String):tweenjs.Tween;
	/**
	...
	**/
	function call(callback:haxe.Constraints.Function, ?params:Array<Dynamic>, ?scope:Dynamic):tweenjs.Tween;
	/**
	...
	**/
	function set(props:Dynamic, ?target:Dynamic):tweenjs.Tween;
	/**
	...
	**/
	function play(?tween:tweenjs.Tween):tweenjs.Tween;
	/**
	...
	**/
	function pause(?tween:tweenjs.Tween):tweenjs.Tween;
	/**
	...
	**/
	static function get(target:Dynamic, ?props:tweenjs.Tween.TweenInitProps):tweenjs.Tween;
	/**
...
typedef TweenInitProps = {
	...
	**/
	@:optional
	var loop : haxe.extern.EitherType<Float, Bool>;
	/**
