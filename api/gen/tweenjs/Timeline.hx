...
**/
@:native('createjs.Timeline') extern class Timeline extends tweenjs.AbstractTween {
	...
	**/
	function addTween(tween:tweenjs.Tween):tweenjs.Tween;
	/**
		
			 * Removes one or more tweens from this timeline.
			 
	**/
	function removeTween(tween:tweenjs.Tween):Bool;
	/**
