...
@:native('createjs.ColorPlugin') extern class ColorPlugin {
	...
	**/
	static function init(tween:tweenjs.Tween, prop:String, value:Dynamic):Dynamic;
	/**
	...
	**/
	static function change(tween:tweenjs.Tween, step:tweenjs.TweenStep, prop:String, value:Dynamic, ratio:Float, end:Bool):Dynamic;
}