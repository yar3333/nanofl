...
**/
@:native("THREE.StereoCamera") extern class StereoCamera extends js.three.cameras.Camera {
	/**
	...
	**/
	var cameraL : js.three.cameras.PerspectiveCamera;
	/**
	...
	**/
	var cameraR : js.three.cameras.PerspectiveCamera;
	/**
		
			 * Update the stereo cameras based on the camera passed in.
			 
	**/
	function update(camera:js.three.cameras.PerspectiveCamera):Void;
}