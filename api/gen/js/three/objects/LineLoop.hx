...
**/
@:native("THREE.LineLoop") extern class LineLoop<TGeometry:(BufferGeometry), BufferGeometry:(Dynamic), TMaterial:(haxe.extern.EitherType<Material, Array<Material>>), Material:(Dynamic)> {
