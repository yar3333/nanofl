...
**/
@:native("THREE.Material") extern class Material extends js.three.core.EventDispatcher<{ var dispose : { }; }> {
	/**
	...
	**/
	var blendColor : js.three.math.Color;
	/**
	...
	**/
	function clone():js.three.materials.Material;
	/**
		
			 * Copy the parameters from the passed material into this material.
			 
	**/
	function copy(material:js.three.materials.Material):js.three.materials.Material;
	/**
	...
	**/
	function onBeforeCompile(parameters:js.three.renderers.webgl.WebGLProgramParametersWithUniforms, renderer:js.three.renderers.WebGLRenderer):Void;
	/**
	...
	**/
	function setValues(values:js.three.materials.MaterialParameters):Void;
	/**
