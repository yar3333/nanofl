...
extern interface ExtrudeGeometryOptions {
	...
	**/
	@:optional
	var curveSegments : haxe.extern.EitherType<Float, { }>;
	/**
	...
	**/
	@:optional
	var steps : haxe.extern.EitherType<Float, { }>;
	/**
	...
	**/
	@:optional
	var depth : haxe.extern.EitherType<Float, { }>;
	/**
	...
	**/
	@:optional
	var bevelEnabled : haxe.extern.EitherType<Bool, { }>;
	/**
	...
	**/
	@:optional
	var bevelThickness : haxe.extern.EitherType<Float, { }>;
	/**
	...
	**/
	@:optional
	var bevelSize : haxe.extern.EitherType<Float, { }>;
	/**
	...
	**/
	@:optional
	var bevelOffset : haxe.extern.EitherType<Float, { }>;
	/**
	...
	**/
	@:optional
	var bevelSegments : haxe.extern.EitherType<Float, { }>;
	/**
	...
	**/
	@:optional
	var extrudePath : haxe.extern.EitherType<js.three.extras.core.Curve<js.three.math.Vector3>, { }>;
	/**
	...
	**/
	@:optional
	var UVGenerator : haxe.extern.EitherType<js.three.geometries.UVGenerator, { }>;
}