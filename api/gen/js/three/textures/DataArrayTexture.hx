...
**/
@:native("THREE.DataArrayTexture") extern class DataArrayTexture extends js.three.textures.Texture {
	/**
	...
	**/
	function new(?data:js.lib.BufferSource, ?width:Float, ?height:Float, ?depth:Float):Void;
	/**
