...
@:native("THREE.Raycaster") extern class Raycaster {
	...
	**/
	function new(?origin:js.three.math.Vector3, ?direction:js.three.math.Vector3, ?near:Float, ?far:Float):Void;
	/**
		
			 * The {@link THREE.RaycasterRay | Ray} used for the raycasting.
			 
	**/
	var ray : js.three.math.Ray;
	/**
	...
	**/
	var params : js.three.core.RaycasterParameters;
	/**
	...
	**/
	function set(origin:js.three.math.Vector3, direction:js.three.math.Vector3):Void;
	/**
		
			 * Updates the ray with a new origin and direction.
			 
	**/
	function setFromCamera(coords:js.three.math.Vector2, camera:js.three.cameras.Camera):Void;
	/**
	...
	**/
	function intersectObject<TIntersected:(js.three.core.Object3D<js.three.core.Object3DEventMap>)>(object:js.three.core.Object3D<js.three.core.Object3DEventMap>, ?recursive:Bool, ?optionalTarget:Array<js.three.core.Intersection<TIntersected>>):Array<js.three.core.Intersection<TIntersected>>;
	/**
	...
	**/
	function intersectObjects<TIntersected:(js.three.core.Object3D<js.three.core.Object3DEventMap>)>(objects:Array<js.three.core.Object3D<js.three.core.Object3DEventMap>>, ?recursive:Bool, ?optionalTarget:Array<js.three.core.Intersection<TIntersected>>):Array<js.three.core.Intersection<TIntersected>>;
}