...
extern interface WebGLLightsState {
	var version : Float;
	var hash : { var directionalLength : Float; var hemiLength : Float; var numDirectionalShadows : Float; var numLightProbes : Float; var numPointShadows : Float; var numSpotMaps : Float; var numSpotShadows : Float; var pointLength : Float; var rectAreaLength : Float; var spotLength : Float; };
