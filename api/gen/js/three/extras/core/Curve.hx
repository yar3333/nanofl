...
**/
@:native("THREE.Curve") extern class Curve<TVector:(haxe.extern.EitherType<js.three.math.Vector2, js.three.math.Vector3>)> {
	function new():Void;
	/**
	...
	**/
	var type(default, null) : js.three.extras.curves.CurveType;
	/**
	...
	**/
	function computeFrenetFrames(segments:Int, ?closed:Bool):{ var binormals : Array<js.three.math.Vector3>; var normals : Array<js.three.math.Vector3>; var tangents : Array<js.three.math.Vector3>; };
	/**
		
			 * Creates a clone of this instance.
			 
	**/
	function clone():js.three.extras.core.Curve<TVector>;
	/**
		
			 * Copies another {@link Curve} object to this instance.
			 
	**/
	function copy(source:js.three.extras.core.Curve<TVector>):js.three.extras.core.Curve<TVector>;
	/**
	...
	**/
	function fromJSON(json:{ }):js.three.extras.core.Curve<TVector>;
}