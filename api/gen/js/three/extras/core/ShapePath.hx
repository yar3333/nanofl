...
@:native("THREE.ShapePath") extern class ShapePath {
	...
	**/
	var subPaths : Array<js.three.extras.core.Path>;
	/**
	...
	**/
	var currentPath(default, null) : js.three.extras.core.Path;
	/**
	...
	**/
	function moveTo(x:Float, y:Float):js.three.extras.core.ShapePath;
	/**
	...
	**/
	function lineTo(x:Float, y:Float):js.three.extras.core.ShapePath;
	/**
	...
	**/
	function quadraticCurveTo(aCPx:Float, aCPy:Float, aX:Float, aY:Float):js.three.extras.core.ShapePath;
	/**
	...
	**/
	function bezierCurveTo(aCP1x:Float, aCP1y:Float, aCP2x:Float, aCP2y:Float, aX:Float, aY:Float):js.three.extras.core.ShapePath;
	/**
	...
	**/
	function splineThru(pts:Array<js.three.math.Vector2>):js.three.extras.core.ShapePath;
	/**
	...
	**/
	function toShapes(isCCW:Bool):Array<js.three.extras.core.Shape>;
}