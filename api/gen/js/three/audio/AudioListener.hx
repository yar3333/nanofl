...
**/
@:native("THREE.AudioListener") extern class AudioListener extends js.three.core.Object3D<js.three.core.Object3DEventMap> {
	/**
	...
	**/
	function removeFilter():js.three.audio.AudioListener;
	/**
	...
	**/
	function setFilter(value:js.html.audio.AudioNode):js.three.audio.AudioListener;
	/**
	...
	**/
	function setMasterVolume(value:Float):js.three.audio.AudioListener;
}