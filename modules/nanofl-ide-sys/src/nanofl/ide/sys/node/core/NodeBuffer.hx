...
interface NodeBuffer// extends Uint8Array
{
	...
	**/
	@:overload(function(value:Uint8Array, ?offset:Int, ?end:Int):NodeBuffer {})
	@:overload(function(value:Int, ?offset:Int, ?end:Int):NodeBuffer {})
	function fill(value:String, ?offset:Int, ?end:Int, ?encoding:String):NodeBuffer;
