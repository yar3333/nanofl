...
@:rtti interface Dialogs {
	function showOpenDialog(options:nanofl.ide.sys.Dialogs.ShowOpenDialogOptions):js.lib.Promise<nanofl.ide.sys.Dialogs.ShowOpenDialogResult>;
	function showSaveDialog(options:nanofl.ide.sys.Dialogs.ShowSaveDialogOptions):js.lib.Promise<nanofl.ide.sys.Dialogs.ShowSaveDialogResult>;
	function showMessageBox(options:nanofl.ide.sys.Dialogs.ShowMessageBoxOptions):js.lib.Promise<nanofl.ide.sys.Dialogs.ShowMessageBoxResult>;
}
...
typedef ShowOpenDialogOptions = {
	...
	**/
	...
	@:optional
	var filters : Array<nanofl.ide.sys.Dialogs.FileFilter>;
	/**
