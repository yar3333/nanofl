...
class Keys
{
	...
	public static function toString(code:Int) : String
	{
		switch (code)
		{
			...
			case Keys.CAPS_LOCK:		return "CapsLock";
			...
			case Keys.LEFT_WINDOW_KEY:	return "LeftWin";
			case Keys.RIGHT_WINDOW_KEY:	return "RightWin";
			case Keys.SELECT_KEY:		return "Select";
			case Keys.NUMPAD_0:			return "Num0";
			case Keys.NUMPAD_1:			return "Num1";
			case Keys.NUMPAD_2:			return "Num2";
			case Keys.NUMPAD_3:			return "Num3";
			case Keys.NUMPAD_4:			return "Num4";
			case Keys.NUMPAD_5:			return "Num5";
			case Keys.NUMPAD_6:			return "Num6";
			case Keys.NUMPAD_7:			return "Num7";
			...
			case Keys.NUM_LOCK:			return "NumLock";
			case Keys.SCROLL_LOCK:		return "ScrollLock";
