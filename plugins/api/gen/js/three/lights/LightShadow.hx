...
**/
@:native("THREE.LightShadow") extern class LightShadow<TCamera:(js.three.cameras.Camera)> {
	/**
	...
	**/
	var mapSize : js.three.math.Vector2;
	/**
	...
	**/
	var map : js.three.renderers.WebGLRenderTarget<js.three.textures.Texture>;
	/**
	...
	**/
	var mapPass : js.three.renderers.WebGLRenderTarget<js.three.textures.Texture>;
	/**
	...
	**/
	function copy(source:js.three.lights.LightShadow<js.three.cameras.Camera>):js.three.lights.LightShadow<js.three.cameras.Camera>;
	/**
		
			 * Creates a new {@link LightShadow} with the same properties as this one.
			 
	**/
	function clone(?recursive:Bool):js.three.lights.LightShadow<js.three.cameras.Camera>;
	/**
	...
	**/
	function getFrustum():js.three.math.Frustum;
	/**
		
			 * Update the matrices for the camera and shadow, used internally by the renderer.
			 
	**/
	function updateMatrices(light:js.three.lights.Light<haxe.extern.EitherType<js.three.lights.LightShadow<js.three.cameras.Camera>, { }>>):Void;
	function getViewport(viewportIndex:Float):js.three.math.Vector4;
	/**
		
			 * Used internally by the renderer to extend the shadow map to contain all viewports
			 
	**/
	function getFrameExtents():js.three.math.Vector2;
	/**
