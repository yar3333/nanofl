...
extern interface WebGLProgramParameters {
	...
	var glslVersion : haxe.extern.EitherType<js.three.GLSLVersion, { }>;
	var precision : js.three.Precision;
	var batching : Bool;
	var instancing : Bool;
	var instancingColor : Bool;
	var supportsVertexTextures : Bool;
	var outputColorSpace : js.three.ColorSpace;
	var alphaToCoverage : Bool;
	var map : Bool;
	var matcap : Bool;
	var envMap : Bool;
	var envMapMode : haxe.extern.EitherType<js.three.Mapping, Bool>;
	...
	var alphaTest : Bool;
	var alphaHash : Bool;
	var combine : haxe.extern.EitherType<js.three.Combine, { }>;
