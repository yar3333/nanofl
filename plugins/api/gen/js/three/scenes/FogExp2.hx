...
**/
@:native("THREE.FogExp2") extern class FogExp2 implements js.three.scenes.FogBase {
	/**
	...
	**/
	function new(color:js.three.math.ColorRepresentation, ?density:Float):Void;
	/**
	...
	**/
	function clone():js.three.scenes.FogExp2;
	/**
