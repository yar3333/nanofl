...
**/
@:native("THREE.Fog") extern class Fog implements js.three.scenes.FogBase {
	/**
	...
	**/
	function new(color:js.three.math.ColorRepresentation, ?near:Float, ?far:Float):Void;
	/**
	...
	**/
	function clone():js.three.scenes.Fog;
	/**
