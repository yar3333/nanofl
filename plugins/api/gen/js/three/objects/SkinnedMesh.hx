...
**/
@:native("THREE.SkinnedMesh") extern class SkinnedMesh<TGeometry:(js.three.core.BufferGeometry<js.three.core.BufferGeometry.NormalBufferAttributes>), TMaterial:(haxe.extern.EitherType<js.three.materials.Material, Array<js.three.materials.Material>>)> {
