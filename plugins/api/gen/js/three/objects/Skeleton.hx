...
@:native("THREE.Skeleton") extern class Skeleton {
	...
	**/
	function new(?bones:Array<js.three.objects.Bone<js.three.core.Object3DEventMap>>, ?boneInverses:Array<js.three.math.Matrix4>):Void;
	/**
	...
	**/
	var boneInverses : Array<js.three.math.Matrix4>;
	/**
	...
	**/
	var boneTexture : js.three.textures.DataTexture;
	var frame : Float;
	function init():Void;
	/**
	...
	**/
	function computeBoneTexture():js.three.objects.Skeleton;
	/**
	...
	**/
	function clone():js.three.objects.Skeleton;
	/**
	...
	**/
	function getBoneByName(name:String):haxe.extern.EitherType<{ }, js.three.objects.Bone<js.three.core.Object3DEventMap>>;
	/**
	...
	**/
	...
	function fromJSON(json:Dynamic, bones:Dynamic<js.three.objects.Bone<js.three.core.Object3DEventMap>>):Void;
}