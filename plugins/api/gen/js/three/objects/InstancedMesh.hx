...
**/
@:native("THREE.InstancedMesh") extern class InstancedMesh<TGeometry:(js.three.core.BufferGeometry<js.three.core.BufferGeometry.NormalBufferAttributes>), TMaterial:(haxe.extern.EitherType<js.three.materials.Material, Array<js.three.materials.Material>>)> {
