...
**/
@:native("THREE.ArrayCamera") extern class ArrayCamera extends js.three.cameras.PerspectiveCamera {
	/**
	...
	**/
	function new(?cameras:Array<js.three.cameras.PerspectiveCamera>):Void;
	/**
	...
	**/
	var cameras : Array<js.three.cameras.PerspectiveCamera>;
}