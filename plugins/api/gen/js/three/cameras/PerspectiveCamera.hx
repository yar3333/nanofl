...
**/
@:native("THREE.PerspectiveCamera") extern class PerspectiveCamera extends js.three.cameras.Camera {
	/**
	...
	**/
	var view : { var enabled : Bool; var fullHeight : Float; var fullWidth : Float; var height : Float; var offsetX : Float; var offsetY : Float; var width : Float; };
	/**
	...
	**/
	function getViewBounds(distance:Float, minTarget:js.three.math.Vector2, maxTarget:js.three.math.Vector2):Void;
	/**
	...
	**/
	function getViewSize(distance:Float, target:js.three.math.Vector2):js.three.math.Vector2;
	/**
