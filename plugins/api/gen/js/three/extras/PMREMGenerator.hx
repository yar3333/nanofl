...
@:native("THREE.PMREMGenerator") extern class PMREMGenerator {
	...
	**/
	function fromScene(scene:js.three.scenes.Scene, ?sigma:Float, ?near:Float, ?far:Float):js.three.renderers.WebGLRenderTarget<js.three.textures.Texture>;
	/**
		
			 * Generates a PMREM from an equirectangular texture.
			 
	**/
	function fromEquirectangular(equirectangular:js.three.textures.Texture, ?renderTarget:js.three.renderers.WebGLRenderTarget<js.three.textures.Texture>):js.three.renderers.WebGLRenderTarget<js.three.textures.Texture>;
	/**
		
			 * Generates a PMREM from an cubemap texture.
			 
	**/
	function fromCubemap(cubemap:js.three.textures.CubeTexture, ?renderTarget:js.three.renderers.WebGLRenderTarget<js.three.textures.Texture>):js.three.renderers.WebGLRenderTarget<js.three.textures.Texture>;
	/**
