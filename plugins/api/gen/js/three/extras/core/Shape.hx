...
**/
@:native("THREE.Shape") extern class Shape extends js.three.extras.core.Path {
	/**
	...
	**/
	var holes : Array<js.three.extras.core.Path>;
	/**
		
			 * Call {@link THREE.Curve.getPoints | getPoints} on the {@link Shape} and the {@link holes} array
			 
	**/
	function extractPoints(divisions:Int):{ var holes : Array<Array<js.three.math.Vector2>>; var shape : Array<js.three.math.Vector2>; };
	/**
		
			 * Get an array of {@link Vector2 | Vector2's} that represent the holes in the shape.
			 
	**/
	function getPointsHoles(divisions:Int):Array<Array<js.three.math.Vector2>>;
}