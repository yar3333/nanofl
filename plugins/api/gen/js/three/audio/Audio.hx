...
**/
@:native("THREE.Audio") extern class Audio<NodeType:(js.html.audio.AudioNode)> extends js.three.core.Object3D<js.three.core.Object3DEventMap> {
	/**
	...
	**/
	function new(listener:js.three.audio.AudioListener):Void;
	/**
		
			 * A reference to the listener object of this audio.
			 
	**/
	var listener : js.three.audio.AudioListener;
	/**
	...
	**/
	var source : js.html.audio.AudioScheduledSourceNode;
	/**
	...
	**/
	function setNodeSource(audioNode:js.html.audio.AudioScheduledSourceNode):js.three.audio.Audio<js.html.audio.GainNode>;
	/**
	...
	**/
	function setMediaElementSource(mediaElement:js.html.MediaElement):js.three.audio.Audio<js.html.audio.GainNode>;
	/**
	...
	**/
	function setMediaStreamSource(mediaStream:js.html.MediaStream):js.three.audio.Audio<js.html.audio.GainNode>;
	/**
	...
	**/
	function setBuffer(audioBuffer:js.html.audio.AudioBuffer):js.three.audio.Audio<js.html.audio.GainNode>;
	/**
		
			 * If {@link Audio.hasPlaybackControl | hasPlaybackControl} is true, starts playback.
			 
	**/
	function play(?delay:Float):js.three.audio.Audio<js.html.audio.GainNode>;
	/**
		
			 * If {@link Audio.hasPlaybackControl | hasPlaybackControl} is true, pauses playback.
			 
	**/
	function pause():js.three.audio.Audio<js.html.audio.GainNode>;
	/**
		
			 * If {@link Audio.hasPlaybackControl | hasPlaybackControl} is enabled, stops playback.
			 
	**/
	function stop():js.three.audio.Audio<js.html.audio.GainNode>;
	/**
	...
	**/
	function connect():js.three.audio.Audio<js.html.audio.GainNode>;
	/**
	...
	**/
	function disconnect():js.three.audio.Audio<js.html.audio.GainNode>;
	/**
	...
	**/
	function setDetune(value:Float):js.three.audio.Audio<js.html.audio.GainNode>;
	/**
	...
	**/
	function setFilter(filter:js.html.audio.AudioNode):js.three.audio.Audio<js.html.audio.GainNode>;
	/**
	...
	**/
	function setFilters(value:Array<js.html.audio.AudioNode>):js.three.audio.Audio<js.html.audio.GainNode>;
	/**
	...
	**/
	function setPlaybackRate(value:Float):js.three.audio.Audio<js.html.audio.GainNode>;
	/**
	...
	**/
	function setLoop(value:Bool):js.three.audio.Audio<js.html.audio.GainNode>;
	/**
		
			 * Set {@link https://developer.mozilla.org/en-US/docs/Web/API/AudioBufferSourceNode/loopStart | source.loopStart} to `value`.
			 
	**/
	function setLoopStart(value:Float):js.three.audio.Audio<js.html.audio.GainNode>;
	/**
		
			 * Set {@link https://developer.mozilla.org/en-US/docs/Web/API/AudioBufferSourceNode/loopEnd | source.loopEnd} to `value`.
			 
	**/
	function setLoopEnd(value:Float):js.three.audio.Audio<js.html.audio.GainNode>;
	/**
	...
	**/
	function setVolume(value:Float):js.three.audio.Audio<js.html.audio.GainNode>;
}