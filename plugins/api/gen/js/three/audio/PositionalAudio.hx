...
**/
@:native("THREE.PositionalAudio") extern class PositionalAudio extends js.three.audio.Audio<js.html.audio.PannerNode> {
	/**
	...
	**/
	override function getOutput():js.html.audio.PannerNode;
	/**
	...
	**/
	function setRefDistance(value:Float):js.three.audio.PositionalAudio;
	/**
	...
	**/
	function setRolloffFactor(value:Float):js.three.audio.PositionalAudio;
	/**
	...
	**/
	function setDistanceModel(value:String):js.three.audio.PositionalAudio;
	/**
	...
	**/
	function setMaxDistance(value:Float):js.three.audio.PositionalAudio;
	/**
	...
	**/
	function setDirectionalCone(coneInnerAngle:Float, coneOuterAngle:Float, coneOuterGain:Float):js.three.audio.PositionalAudio;
}