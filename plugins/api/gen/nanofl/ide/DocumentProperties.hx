...
extern class DocumentProperties extends nanofl.ide.InjectContainer {
	function new(?title:String, ?width:Int, ?height:Int, ?backgroundColor:String, ?framerate:Float, ?scaleMode:String, ?clickToStart:Bool, ?publishSettings:nanofl.ide.PublishSettings):Void;
	var title : String;
	var width : Int;
	var height : Int;
