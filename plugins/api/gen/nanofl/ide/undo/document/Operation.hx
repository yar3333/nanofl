...
extern enum Operation {
	...
	ELEMENTS(navigatorState:nanofl.ide.undo.states.NavigatorState, oldElementsState:nanofl.ide.undo.states.ElementsState, newElementsState:nanofl.ide.undo.states.ElementsState);
