...
extern class LibraryDragAndDropTools {
	...
	static function getDragData(document:nanofl.ide.Document, item:nanofl.ide.libraryitems.IIdeLibraryItem, draggedWithDependencies:Array<nanofl.ide.libraryitems.IIdeLibraryItem>, selectedNamePaths:Array<String>):String;
