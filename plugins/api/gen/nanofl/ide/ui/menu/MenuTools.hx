...
extern class MenuTools {
	...
	static function updateItemStates(container:js.JQuery, app:nanofl.ide.Application, openedFiles:nanofl.ide.OpenedFiles, clipboard:nanofl.ide.Clipboard, preferences:nanofl.ide.preferences.Preferences, timelineView:nanofl.ide.ui.views.TimelineView):Void;
