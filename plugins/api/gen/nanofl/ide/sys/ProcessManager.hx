...
interface ProcessManager {
	...
	function runPipedStdOut(filePath:String, args:Array<String>, directory:String, env:Dynamic<String>, input:String, chunkSize:Int, processChunk:js.lib.Uint8Array -> Void):js.lib.Promise<nanofl.ide.sys.ProcessResult>;
}