...
extern class Invalidater {
	...
	function updateInvalidated(editor:nanofl.ide.editor.Editor, timeline:nanofl.ide.timeline.ITimeline, libraryView:components.nanofl.library.libraryview.Code):Void;
}