...
**/
@:native('createjs.PlayPropsConfig') extern class PlayPropsConfig {
	function new():Void;
	/**
	...
	**/
	function set(props:Dynamic):soundjs.data.PlayPropsConfig;
	/**
		
			 * Creates a PlayPropsConfig from another PlayPropsConfig or an Object.
			 
	**/
	static function create(value:Dynamic):soundjs.data.PlayPropsConfig;
}