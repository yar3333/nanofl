...
class CodeGenerator extends InjectContainer
{
	...
	public static function generate(library:IdeLibrary, destDir:String)
	{
        ...
        final srcDir = Path.directory(destDir);
        generator.generateUserTsFiles(srcDir);
        generator.generateApplicationTs(srcDir + "/application.ts");
        
        final baseDir = Path.directory(Path.directory(destDir));
        generator.generatePackageJsonFile(baseDir + "/package.json");
    ...
    function generatePackageJsonFile(destJsonFilePath:String)
    {
        ...
        fileSystem.copyFile(folders.application + "/templates/package.json", destJsonFilePath);
    }
