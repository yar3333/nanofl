...
class CodeGenerator extends InjectContainer
{
	...
	public static function generate(projectName:String, library:IdeLibrary, destDir:String)
	{
        ...
        generator.generateAutogeneratedIndexTsFile(destDir + "/index.ts");
       
        final destSrcDir = Path.directory(destDir);
        generator.generateUserTsFiles(destSrcDir);
        generator.generateApplicationTs(destSrcDir + "/application.ts");
        
        final baseDestDir = Path.directory(destSrcDir);
        generator.generatePackageJsonFile(projectName, baseDestDir + "/package.json");
        generator.generateTsConfigJsonFile(baseDestDir + "/tsconfig.json");
        generator.generateWebpackConfigJsFile(baseDestDir + "/webpack.config.js");
        generator.generateVsCode(baseDestDir + "/.vscode");
    }
    ...
    function generatePackageJsonFile(projectName:String, destJsonFilePath:String)
    {
    ...
    function generateWebpackConfigJsFile(destJsFilePath:String)
    {
        ...
        fileSystem.copyFile(folders.application + "/templates/webpack.config.js", destJsFilePath);
    }
