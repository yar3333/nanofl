...
class Bucket extends _autogenerated_base__WEBPACK_IMPORTED_MODULE_0__.base.Bucket {
    constructor(total, x) {
        super();
    ...
    init() {
        ...
        switch (this.level) {
            case 1:
                ...
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(5, 220)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(7, 320)));
                break;
            case 2:
                this.scene.tfTask.text = "You need to measure 1 liter of water.";
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(3, 180)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(6, 280)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(8, 380)));
                break;
            case 3:
                this.scene.tfTask.text = "You need to measure 1 liter of water.";
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(3, 220)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(5, 320)));
                break;
            case 4:
                this.scene.tfTask.text = "You need to got 1 liter of water in any two buckets.";
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(3, 180)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(4, 280)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(6, 380)));
                break;
            case 5:
                this.scene.tfTask.text = "You need to got 6 litres of water in bigger bucket,\n4 liters in 5-bucket and 4 litres in 8-bucket.";
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(3, 180)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(5, 250)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(8, 320)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(12, 400)));
                break;
            case 6:
                this.scene.tfTask.text = "You need to got 2 liter of water in any three buckets.";
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(3, 180)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(3, 250)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(8, 320)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(11, 400)));
                break;
            case 7:
                this.scene.tfTask.text = "You need to got 1 liter of water in any two buckets..";
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(2, 180)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(3, 280)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(9, 380)));
                break;
            case 8:
                this.scene.tfTask.text = "You need to got 1 liter of water in small three buckets.";
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(5, 180)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(7, 250)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(9, 320)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(11, 400)));
                break;
            case 9:
                ...
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(7, 180)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(11, 250)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(13, 320)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(17, 400)));
                break;
            case 10:
                this.scene.tfTask.text = "You must to got 18 litres in 19-bucket and 5 litres in 6-bucket.";
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(2, 180)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(6, 280)));
                this.buckets.push(this.addChild(new _Bucket__WEBPACK_IMPORTED_MODULE_2__.Bucket(19, 380)));
                break;
        }
    }
    onEnterFrame() {
...
class Trash extends _autogenerated_base__WEBPACK_IMPORTED_MODULE_0__.base.Trash {
    constructor() {
        super(...arguments);
        this.total = 100000;
    }
