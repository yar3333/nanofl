    ...
    init() {
        ...
        switch (this.level) {
            case 1:
                ...
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(5, 220)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(7, 320)));
                break;
            case 2:
                this.parent.tfTask.text = "You need to measure 1 liter of water.";
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(3, 180)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(6, 280)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(8, 380)));
                break;
            case 3:
                this.parent.tfTask.text = "You need to measure 1 liter of water.";
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(3, 220)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(5, 320)));
                break;
            case 4:
                this.parent.tfTask.text = "You need to got 1 liter of water in any two buckets.";
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(3, 180)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(4, 280)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(6, 380)));
                break;
            case 5:
                this.parent.tfTask.text = "You need to got 6 litres of water in bigger bucket,\n4 liters in 5-bucket and 4 litres in 8-bucket.";
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(3, 180)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(5, 250)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(8, 320)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(12, 400)));
                break;
            case 6:
                this.parent.tfTask.text = "You need to got 2 liter of water in any three buckets.";
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(3, 180)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(3, 250)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(8, 320)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(11, 400)));
                break;
            case 7:
                this.parent.tfTask.text = "You need to got 1 liter of water in any two buckets..";
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(2, 180)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(3, 280)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(9, 380)));
                break;
            case 8:
                this.parent.tfTask.text = "You need to got 1 liter of water in small three buckets.";
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(5, 180)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(7, 250)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(9, 320)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(11, 400)));
                break;
            case 9:
                ...
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(7, 180)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(11, 250)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(13, 320)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(17, 400)));
                break;
            case 10:
                this.parent.tfTask.text = "You must to got 18 litres in 19-bucket and 5 litres in 6-bucket.";
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(2, 180)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(6, 280)));
                this.buckets.push(this.addChild(new _McBucket__WEBPACK_IMPORTED_MODULE_1__.McBucket(19, 380)));
                break;
        }
    }
    onEnterFrame() {
...
class McTrash extends _autogen__WEBPACK_IMPORTED_MODULE_0__.base.McTrash {
    constructor() {
        super(...arguments);
        this.total = 100000;
    }
...
/* harmony export */   McTrash: () => (/* reexport safe */ _McTrash__WEBPACK_IMPORTED_MODULE_2__.McTrash),
/* harmony export */   MusicButton: () => (/* reexport safe */ _MusicButton__WEBPACK_IMPORTED_MODULE_3__.MusicButton),
/* harmony export */   Scene: () => (/* reexport safe */ _Scene__WEBPACK_IMPORTED_MODULE_4__.Scene),
/* harmony export */   Sounds: () => (/* reexport safe */ _autogen__WEBPACK_IMPORTED_MODULE_5__.Sounds),
/* harmony export */   base: () => (/* reexport safe */ _autogen__WEBPACK_IMPORTED_MODULE_5__.base)
/* harmony export */ });
/* harmony import */ var _Game__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Game */ "./src/Game.ts");
/* harmony import */ var _McBucket__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./McBucket */ "./src/McBucket.ts");
/* harmony import */ var _McTrash__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./McTrash */ "./src/McTrash.ts");
/* harmony import */ var _MusicButton__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./MusicButton */ "./src/MusicButton.ts");
/* harmony import */ var _Scene__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Scene */ "./src/Scene.ts");
/* harmony import */ var _autogen__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./autogen */ "./src/autogen.ts");
