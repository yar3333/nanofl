...
class Sounds {
    static bucket(props) { return createjs.Sound.play("bucket", props); }
    static music(props) { return createjs.Sound.play("music", props); }
    static tap(props) { return createjs.Sound.play("tap", props); }
    static trash(props) { return createjs.Sound.play("trash", props); }
    static water(props) { return createjs.Sound.play("water", props); }
}
